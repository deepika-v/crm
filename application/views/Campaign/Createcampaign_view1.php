  ...
  <!-- BEGIN PAGE HEAD -->
    <div class="container">
      ...
      <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
          Create Campaign<i class="fa fa-circle"></i>
        </li>
      </ul>
      </div>
      <!-- END PAGE TITLE -->
      ...
      <div class="row">
        ...
        <div class='panel-heading'>
         <ul class="nav nav-pills">
                  <li class="active"><a data-toggle="tab" href="#createcampaign">Create Campaign<span class="required">*</span></a></li>
                  <li><a href="<?php echo base_url('Search_contact');?>" class="linkcss"><u>Assign Lead<u></a></li>
         </ul>
       </div>
        ...
        <?php echo $this->session->flashdata('msg');?>
         <div class="tab-content">
              <div id="createcampaign" class="tab-pane fade in active">
                ...
                echo form_open('Campaign/createcampaign', $attributes); 
              ?>
                      <div class="form-body">
                      <hr>
                      ...
                      <h4><strong>General:</strong></h4>
                       <div class="form-group">
                          ...
                          <div class="col-md-4">
                            <input type="text" class="form-control input-circle" placeholder="Enter text" name="campaignname"  id="campaignname"  value="<?php echo set_value('campaignname'); ?>">
                          ...
                          <div class="col-md-4">
                            <textarea name="description" rows="2" class="form-control input-circle" placeholder="Enter text" value="<?php echo set_value('description'); ?>"></textarea>
                        ...
                        echo form_dropdown('owner', $options, set_value('owner') ,'class="form-control input-circle"');
                        ...
                        <div class="form-group">
                          <label class="col-md-3 control-label">Create Campaign Team<span class="required">*</span></label>
                          <div class="col-md-4">
                            <?php 
                        ...
                        echo form_multiselect('team[]', $options, set_value('team[]') ,'class="form-control input-circle"');
                            ?>
