  ...
  <div class="col-md-12">
    <div class='panel panel-default'>
      <div class='panel-heading'>
        <h4>Campaign Details<p class="pull-right"><form method="post" class="pull-right" action="<?= base_url();?>Displaycampaign/"><input type="checkbox" id="campaignstatus" name="campaignstatus" <?php if(@$this->input->post('campaignstatus') == '1'){ echo 'checked = \"true\"'; } ?>  onchange = "this.form.submit()"  class="make-switch" data-on-text="<strong>Inactive</strong>" data-off-text="<strong>Active</strong>" data-off-color="primary" data-on-color="default" value="1"  >&nbsp;&nbsp;<strong><?php echo $totalcampaignrun;?>&nbsp;&nbsp;</strong>Campaigns </p></h4>
      </div>
