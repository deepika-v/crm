                                                                    ...
                                                                    <div class="col-md-8">
                                                                       <div class="btn-group" data-toggle="buttons">
                                                                              <label class="btn btn-default active" onclick="hidedisplaysearch()">
                                                                                    <input type="radio" name="Contacttype" id="all" value="0"<?php if(set_value('Contacttype')=='0'){ ?> checked=checked <?php } ?>  checked="true">All
                                                                              </label>
                                                                              ...
                                                                              <label class="btn btn-default" onclick="hidedisplaysearch()">
                                                                                      ...
                                                                                      <label class="btn btn-default" onclick="hidedisplaysearch()">
                                                                                      <input type="radio" name="Contacttype" id="openprospect" value="OP" <?php if(set_value('Contacttype')=='prospect'){ ?> checked=checked <?php } ?>>Opened Emails</label>
