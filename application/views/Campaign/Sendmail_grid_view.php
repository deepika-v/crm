...
<table class="table table-striped table-bordered table-hover" id="sample_1">
                  ...
                  //echo "</pre>";
    {
      ...
      {
        //$sendmaildetails->succeed = '0';
        //$sendmaildetails->failed = '0';
        echo "<tr>"; 
        //echo "<td>".$j."</td>";             
      ...
      $s_date = $startdate->format('d-m-Y');
        ...
        echo "<td>".$sendmaildetails->failedmails."</td>";
        echo "<td>".$sendmaildetails->succeedmails."</td>";
    ...
    //alert(url);
     $.ajax({
            ...
            success: function(response)
            {
              ...
              $("#messagetitle").html("<h3>Details</h3>");
