              ...
              ?>
                      <div class="form-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-8"><p class="form-control-static" id="total_contacts"><?php echo set_value('totalcontacts');?></p> 
                        ...
                        echo form_dropdown('filter_id', $options,'',$contacttype_attributes);
                          //}
                            ...
                            &nbsp;&nbsp;<p class="form-control-static"  id="filtered_contacts"></p>
                             ...
                             <input type="hidden" class="form-control input-circle" name="totalcontacts"  id="totalcontacts" value="<?php echo set_value('totalcontacts');?>">
                         ...
                         <div class="form-group">
                          ...
                          <div class="col-md-4">
                            <input type="text" class="form-control input-circle" placeholder="Enter text" name="sendersemail"  id="sendersemail" value="info@lurningo.com" >
