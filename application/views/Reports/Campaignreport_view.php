...
<head> 
<meta charset="utf-8"/>
<title>CRM | Campaign wise report</title>
  ...
  <!-- BEGIN PAGE HEAD -->
    <div class="container">
      ...
      <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
          Campaign wise report<i class="fa fa-circle"></i>
        </li>
      </ul>
      </div>
      <!-- END PAGE TITLE -->
  ...
  <div class="page-content">
   ...
   <div class="modal fade bs-modal-lg" id="modalview" tabindex="-1" role="dialog" aria-hidden="true">
      ...
      <div class="row">
        ...
        <div class='panel-heading'><h4>Campaign wise Summary Report</h4>
         </div>
                 ...
                 <div class="portlet-body form">
                   ...
                   <div class="row"> 
                     ...
                     <div class="form-group">
                      ...
                      <span class="help-block" id="fromdate_error"> </span>
                       </div>
                      ...
                      <span class="help-block" id="todate_error"></span>
                          </div> 
                        </div>
                   </div> 
...
function displaytable()
{
  ...
  if(from_date != '' && to_date != '')
  {
    ...
    document.getElementById('classdata').innerHTML="<img src='<?php echo base_url('assets/images/loader1.gif');?>'><h4><strong>Loading....</strong></h4> ";
     url = '<?php echo base_url()."Reports/campaignreport/'+from_date+'/'+to_date+'";?>';
    //alert(url);
     $.ajax({
            type: 'POST',
            url: url,
            ...
            success: function(response)
            {
              ...
              $.fn.dataTable.ext.errMode = 'none';
                    ...
                    csvurl = "<?php echo base_url().'Reports/generate_campaign_csv/';?>";
...
function display_totalcontactsdetails(campaignid)
{
  //alert("in function");
  from_date = document.getElementById('datefrom').value;
  to_date = document.getElementById('dateto').value;
   document.getElementById('classdata').style.display = 'block';
    document.getElementById('classdata').innerHTML="<img src='<?php echo base_url('assets/images/loader1.gif');?>'><h4><strong>Loading....</strong></h4> ";
    url = '<?php echo base_url()."Reports/campaign_report_display_totalcontacts/'+from_date+'/'+to_date+'/'+campaignid+'";?>';
...
function display_opencontactsdetails(campaignid)
{
  //alert("in function");
  from_date = document.getElementById('datefrom').value;
  to_date = document.getElementById('dateto').value;
   document.getElementById('classdata').style.display = 'block';
    document.getElementById('classdata').innerHTML="<img src='<?php echo base_url('assets/images/loader1.gif');?>'><h4><strong>Loading....</strong></h4> ";
    url = '<?php echo base_url()."Reports/campaign_report_display_opencontacts/'+from_date+'/'+to_date+'/'+campaignid+'";?>';
...
function display_closedcontactsdetails(campaignid)
{
  //alert("in function");
  from_date = document.getElementById('datefrom').value;
  to_date = document.getElementById('dateto').value;
   document.getElementById('classdata').style.display = 'block';
    document.getElementById('classdata').innerHTML="<img src='<?php echo base_url('assets/images/loader1.gif');?>'><h4><strong>Loading....</strong></h4> ";
    url = '<?php echo base_url()."Reports/campaign_report_display_closedcontacts/'+from_date+'/'+to_date+'/'+campaignid+'";?>';
...
function display_droppedcontactsdetails(campaignid)
{
  //alert("in function");
  from_date = document.getElementById('datefrom').value;
  to_date = document.getElementById('dateto').value;
   document.getElementById('classdata').style.display = 'block';
    document.getElementById('classdata').innerHTML="<img src='<?php echo base_url('assets/images/loader1.gif');?>'><h4><strong>Loading....</strong></h4> ";
    url = '<?php echo base_url()."Reports/campaign_report_display_droppedcontacts/'+from_date+'/'+to_date+'/'+campaignid+'";?>';
