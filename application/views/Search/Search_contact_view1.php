    ...
    <?php echo $this->session->flashdata('msg');?>
          ...
          <form class="form-inline" method="post" action="Search_contact/Search" role="form">
            ...
            <div class="col-md-4">
                ...
                <div class="col-md-10">
                 <select multiple="multiple" placeholder="Select University" class="SlectBox form-control col-md-6" name="university[]">
                    <?php 
            ...
            <div class="row"> 
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label style="float: left;margin-right: 10px">Age group:</label>
                    <input type="number" class="col-md-3" placeholder="From" name="from" min="1">
                    <input type="number" class="col-md-3" placeholder="To" name="to" value="" min="1">
                </div>
              </div>
