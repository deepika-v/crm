        ...
        <?php echo $this->session->flashdata('msg');?>
         <div class="tab-content">
              <div id="createcampaign" class="tab-pane fade in active">
                ...
                echo form_open('User/createheader', $attributes); 
               // if($campaignid!=""){
                //print_r($campaignid);
              //}
              ?>
                      <div class="form-body">
                        ...
                        foreach($userrole as $userrole) {        
                                $options[$userrole->UserRoleID] = ucfirst($userrole->UserRole);
                          }
                        echo form_dropdown('UserID', $options, set_value('UserID') ,$campaign_attributes);
                              }
                            ?>
                        ...
                        <div class="row">
                          <div class="col-md-offset-3 col-md-9">
                            <button type="submit" class="btn btn-circle blue" id="createuser">Create Menu</button>
                            </div>
                        </div>
                      </div>
                    </form>
